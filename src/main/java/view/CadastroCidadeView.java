...
public class CadastroCidadeView extends ControllerView {
    ...
    private CadastroCidadeController controller;

    public CadastroCidadeView(CadastroCidadeController controller) {
    ...
    private JPanel getPanelDescricao() {
        if (panelDescricao == null) {
            ...
            gblPanelDescricao.columnWidths = new int[]{300, 90};
            ...
            GridBagConstraints gbcLblUf = new GridBagConstraints();
            gbcLblUf.fill = GridBagConstraints.BOTH;
            gbcLblUf.insets = new Insets(5, 5, 5, 5);
            gbcLblUf.gridx = 1;
            gbcLblUf.gridy = 0;
            panelDescricao.add(getLblUf(), gbcLblUf);

            GridBagConstraints gbcCBEstados = new GridBagConstraints();
            gbcCBEstados.fill = GridBagConstraints.BOTH;
            gbcCBEstados.insets = new Insets(0, 5, 5, 5);
            gbcCBEstados.gridx = 1;
            gbcCBEstados.gridy = 1;
            panelDescricao.add(getCBEstados(), gbcCBEstados);
        }
    ...
    public JTextField getTxtCodigo() {
        if (txtCodigo == null) {
            ...
            txtCodigo.addActionListener(a -> controller.buscaCidade());
        }
        return txtCodigo;
    }
    ...
    public JComboBox<String> getCBEstados() {
        if (estados == null) {
            estados = new JComboBox(new String[]{"", "MG", "MS", "PI", "SC", "TO", "BA", "AL", "ES", "RR", "AP", "CE", "DF", "SE", "AM", "GO", "PR", "AC", "MT", "PA", "RJ", "RO", "RS", "SP", "RN", "MA", "PB", "PE"});
            estados.setFont(new Font("Tahoma", Font.PLAIN, 10));
        }
        return estados;
    }
