...
import controller.CadastroCorController;
...
public class CadastroCorView extends ControllerView {
    ...
    private CadastroCorController controller;

    public CadastroCorView(CadastroCorController controller) {
    ...
    public JTextField getTxtCodigo() {
        if (txtCodigo == null) {
            ...
            txtCodigo.addActionListener(a -> controller.buscaCor());
        }
        return txtCodigo;
    }
