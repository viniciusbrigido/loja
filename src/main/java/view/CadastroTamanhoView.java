...
import controller.CadastroTamanhoController;
...
public class CadastroTamanhoView extends ControllerView {
    ...
    private CadastroTamanhoController controller;

    public CadastroTamanhoView(CadastroTamanhoController controller) {
    ...
    public JTextField getTxtCodigo() {
        if (txtCodigo == null) {
            ...
            txtCodigo.addActionListener(a -> controller.buscaTamanho());
        }
        return txtCodigo;
    }
