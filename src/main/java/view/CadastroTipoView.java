...
import controller.CadastroTipoController;
...
public class CadastroTipoView extends ControllerView {
    ...
    private CadastroTipoController controller;

    public CadastroTipoView(CadastroTipoController controller) {
        setTitle("Cadastro de Tipo de Produtos");
    ...
    public JTextField getTxtCodigo() {
        if (txtCodigo == null) {
            ...
            txtCodigo.addActionListener(a -> controller.buscaTipoProduto());
        }
        return txtCodigo;
    }
